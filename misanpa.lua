...
world1=v114;
while wait() do
		if world1 == false then break end
...
world2=v116;
while wait() do
		if world2 == false then break end
...
world3=v115;
while wait() do
		if world3 == false then break end
...
world4=v117;
while wait() do
		if world4 == false then break end
...
world5=v118;
while wait() do
		if world5 == false then break end
			game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.4.7").knit.Services.ZoneService.RE.teleport:FireServer(workspace.Zones.[5].Interactables.Teleports.Locations.DinoWorld);
	end
end});
...
world6=v119;
while wait() do
		if world6 == false then break end
			game:GetService("ReplicatedStorage").Packages._Index:FindFirstChild("sleitnick_knit@1.4.7").knit.Services.ZoneService.RE.teleport:FireServer(workspace.Zones.[6].Interactables.Teleports.Locations.VoidWorld);
	end
end});
...
world7=value;
while wait() do
		if world7 == false then break end
...
holloweenT=value;
while wait() do
		if holloweenT == false then break end
