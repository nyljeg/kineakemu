...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "ZlJyYhsjisuJjMttP" then   
screenGui:Destroy()

--Your Script
loadstring(game:HttpGet("https://raw.githubusercontent.com/Elmerhub/basketbaII/main/1097388910273.lua"))()
...
GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://direct-link.net/1003806/download-saw-key") 
end) 
